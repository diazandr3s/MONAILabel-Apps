...
def save_nifti(data, meta_data, path):
    ...
    filename = meta_data['filename_or_obj'][0].split('/')[-1] + '.gz'
...
data_dir = "INPUT_PATH/lung_images"
train_images = sorted(glob.glob(os.path.join(data_dir, "ct_imgs", "*.nii")))
...
output_folder = 'OUTPUT_PATH/lung_images/'
